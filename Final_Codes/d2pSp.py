...
print("First half (CS1): {} flies".format(first_half))
print("Second half (CS2): {} flies".format(second_half))
print("=" * 60)
...
for fly_num in xrange(first_half):
    ...
    for trials in range(3):
        for pulses in range(12):
            ...
            pid.stdin.write("1/1 3/1\n")    #UCS+ & CS1+
            x = pid.stdout.readline()

            pid.stdin.write("2/1 4/1\n")   #UCS- & CS1-
            x = pid.stdout.readline()
...
for fly_num in range(second_half):
...
# Calculate PI Value
print("Calculating Performance Index (PI) Values")
print("=" * 60)
...
print("First Half (CS1 Test) Results:")
